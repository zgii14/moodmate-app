export const renderNavbar = () => {
    ...
    <ul class="hidden md:flex text-base md:text-lg items-center desktop-menu" style="gap:1rem;">
      ...
      ${!isLoggedIn
        ? `<li><a href="#/" class="${getActiveClass('#/')}">Home</a></li>
           <li><a href="#/about" class="${getActiveClass('#/about')}">About</a></li>
        ...
        : `<li><a href="#/dashboard" class="${getActiveClass('#/dashboard')}">Dashboard</a></li>
           <li><a href="#/journal" class="${getActiveClass('#/journal')}">Catatan</a></li>
           <li><a href="#/riwayat" class="${getActiveClass('#/riwayat')}">Riwayat</a></li>
           <li class="relative group ml-4">
              <img src="/images/profile.png" class="h-10 w-10 rounded-full cursor-pointer border-2 ${currentHash === '#/profil' ? 'border-blue-600 shadow-lg scale-105' : 'border-transparent hover:border-gray-300 hover:shadow-md hover:scale-105'} transition-all duration-300 ease-in-out transform" id="profileToggle" />
              <div class="profile-dropdown absolute top-full right-0 bg-white dark:bg-gray-700 shadow-xl rounded-lg w-44 mt-2 text-base border dark:border-gray-600" id="profileDropdown">
                <a href="#/profil" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-white hover:pl-6 transition-all duration-200 ease-in-out ${currentHash === '#/profil' ? 'bg-blue-50 text-blue-600 dark:bg-blue-900 dark:text-blue-300' : ''}"><i class="fas fa-user mr-2"></i> Profil</a>
  ...
  if (!nav) {
    ...
    nav.className = "fixed top-0 left-0 w-full z-50 flex justify-between items-center px-4 md:px-10 py-4 bg-white/90 dark:bg-gray-800/90 shadow backdrop-blur-md";
  ...
  const createMobileMenu = () => {
    ...
    const mobileMenuContent = `
      ...
      <div class="space-y-0">
        ${!isLoggedIn
          ? `<a href="#/" class="${getMobileActiveClass('#/')}" data-close-menu><i class="fas fa-home mr-2"></i> Home</a>
             <a href="#/about" class="${getMobileActiveClass('#/about')}" data-close-menu><i class="fas fa-info-circle mr-2"></i> About</a>
             <a href="#/contact" class="${getMobileActiveClass('#/contact')}" data-close-menu><i class="fas fa-phone mr-2"></i> Contact</a>
          ...
          : `<a href="#/dashboard" class="${getMobileActiveClass('#/dashboard')}" data-close-menu><i class="fas fa-tachometer-alt mr-2"></i> Dashboard</a>
             <a href="#/journal" class="${getMobileActiveClass('#/journal')}" data-close-menu><i class="fas fa-book mr-2"></i> Catatan</a>
             <a href="#/riwayat" class="${getMobileActiveClass('#/riwayat')}" data-close-menu><i class="fas fa-history mr-2"></i> Riwayat</a>
             <a href="#/profil" class="${getMobileActiveClass('#/profil')}" data-close-menu><i class="fas fa-user mr-2"></i> Profil</a>
